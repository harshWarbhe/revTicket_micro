...
public class SeatController {
    ...
    public ResponseEntity<List<String>> getBookedSeats(@PathVariable("showtimeId") String showtimeId) {
        return ResponseEntity.ok(seatService.getBookedSeatIds(showtimeId));
    }
